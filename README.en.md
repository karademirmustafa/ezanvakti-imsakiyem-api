...
## **API Documentation Resources**  
 ...
 [Open Data Set](open-data/prayer-times/README.md) - JSON format prayer times data for Türkiye and KKTC ([v1.0.0 Release](https://github.com/karademirmustafa/ezanvakti-imsakiyem-api/releases/tag/v1.0.0))  
